...
// Delete contact from address book array
{
    ...
    let addressBookArr = new Array();
    let addressBookContacts1 = new AddressBookContacts("Kumar", "Kartikeya", "Techman City", "Agra", "Uttar Pradesh", "281006", "7206183244", "kumar.kartikeya@capgemini.com");
    let addressBookContacts2 = new AddressBookContacts("Shashank", "Singh", "Techman City", "Agra", "Uttar Pradesh", "281006", "8265800789", "shashank.singh@gmail.com");
    addressBookArr.push(addressBookContacts1);
    addressBookArr.push(addressBookContacts2);
    for(let i=0; i<addressBookArr.length; i++)
    {
